            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
						...
						<input type="submit" class="btn btn-success btn-lg" name="dec" value="Decrypt!" />
						</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Decrypt</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
			   ...
			   <div class="col-md-6">
                        <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                            <textarea  rows="13" name="encrypted_msg" class="form-control"></textarea>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                            <textarea  rows="13" name="private_key" class="form-control"></textarea>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                            <textarea  rows="13"  class="form-control"><?php echo $decrypted_msg; ?></textarea>
                                        </div>
                                    </div>
                                </div>
